...
// function to set the numberCorrect and numberIncorrect variables equal to the number of correct and incorrect digits in the user's guess
{
...
// function to overload the == operator as a comparison operator for the response class
{
...
// function to overload the << operator so that it outputs the number of correct and incorrect digits in a guess
{
