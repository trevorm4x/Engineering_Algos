...
//setValue function that takes in value and sets the cardValue variable to the associated value
{
    switch (value) {
        case 1:
            cardValue = "1";
...
//setSuit function that takes in a suit integer and sets the cardSuit variable to the associated value
{
    if (suit == 1) {
        cardSuit = "Club";
    }
